...
const file_common_pagination_proto_rawDesc = "" +
	"\n" +
	"\x17common/pagination.proto\x12\x10oncall.common.v1\">\n" +
	"\vPageRequest\x12\x12\n" +
	"\x04page\x18\x01 \x01(\x05R\x04page\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\"$\n" +
	"\fPageResponse\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x03R\x05totalBAZ?github.com/oyzg/OnCall/backend/go-api/gen/proto/common;commonpbb\x06proto3"
...
var file_common_pagination_proto_goTypes = []any{
	(*PageRequest)(nil),  // 0: oncall.common.v1.PageRequest
	(*PageResponse)(nil), // 1: oncall.common.v1.PageResponse
}
